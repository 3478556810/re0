...
export class CombatEngine {
  ...
  this.player = new UnitState({
    ...playerStats,
    isPlayer: true,
    stackingAtk: playerStats.stackingAtk || 0,                // 肾上腺素
    specialBossDmg: playerStats.specialBossDmg || 0,
    specialFullHpDmg: playerStats.specialFullHpDmg || 0,
    specialIgnoreDef: playerStats.specialIgnoreDef || 0,
    specialLifestealPercent: playerStats.specialLifestealPercent || 0,
    specialMpLifestealPercent: playerStats.specialMpLifestealPercent || 0,
  });
