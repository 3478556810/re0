...
/**
 * \u00AD - Soft hyphen.
 */ export const breakingCharacters = `${breakingSpaceCharacters}\t\n\r-–—\u00AD`;
/**
...
export function getUnbreakableSlice(text, start = 0) {
  let offset = start;
 ...
 */ export function makeAllParentListElementsTransparent(node) {
